...
<div class="">
			...
			<el-col :span="24">
				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-menu-item index="/Share"><i class="fa fa-wa fa-archive"></i> 分类</el-menu-item>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(../../../../static/img/headbg03.jpg)'}">
		...
		<div class="h-information">
			<a href="#/Aboutme">
                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'../../../../static/img/weixin.jpg'" alt="" title="Hello,I'm WuXiaoguo">
                </a>
			<h2 class="h-description">
                    <a href="#/Aboutme">
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"target-oriented programming."}}
                    </a>
                </h2>
		</div>
	</div>
