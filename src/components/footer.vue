...
<template>
    ...
    <div class="footBack footBackQian">
        ...
        <div class="fcontainer">
            <p>
                © 2019 <a href="#">Blog</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By <a href="http://www.mangoya.cn/" target="_blank">Mango Ya</a>.
            </p>
            <p>
                <span>Made with &nbsp;</span><span>Wu Xiaoguo.</span>
            </p>
        </div>
    </div>
</template>
